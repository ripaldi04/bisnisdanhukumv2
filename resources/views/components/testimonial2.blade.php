<section id="testimonial"
    class="h-fit  container mx-auto flex flex-col  py-[70px] px-5 gap-[30px] bg-[#F5F8FA] rounded-[32px]">
        ...
        <div class="swiper-wrapper">
            @foreach ($testimonials as $testimonial)
                <div class="swiper-slide flex flex-col items-center space-y-4 p-6 bg-white rounded-lg shadow-md">
                    <img
                        src="{{ $testimonial->avatar ? Storage::url($testimonial->avatar) : asset('assets/user.svg') }}"  class="w-24">

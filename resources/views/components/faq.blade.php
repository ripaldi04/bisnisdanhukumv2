<section id="faq" class="container mx-auto px-10 lg:px-[100px] py-[70px]">
    ...
    <div class="flex flex-col space-y-3 mt-8 text-center items-center">
        ...
        <a href="https://wa.me/{{ $course->phone }}?text=Halo%20Sekolah%20Marketing%20Properti,%20saya%20mau%20daftar.%20Bagaimana%20caranya?"
            target="_blank"
